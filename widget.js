...
cpdefine("inline:com-chilipeppr-widget-touchplate", ["chilipeppr_ready", 'Three'], function() {
    return {
        ...
        desc: "The Touch Plate widget enables you to easily use the probing feature on your TinyG to electronically find your exact Z zero position of your work surface.",
        publish: {},
        subscribe: {},
        foreignPublish: {},
        foreignSubscribe: {},
        ...
        forkSetup: function() {
            var topCssSelector = '#com-chilipeppr-widget-touchplate';
            ...
            chilipeppr.load("http://fiddle.jshell.net/chilipeppr/zMbL9/show/light/", function() {
                require(['inline:com-chilipeppr-elem-pubsubviewer'], function(pubsubviewer) {
                    pubsubviewer.attachTo($('#com-chilipeppr-widget-touchplate .panel-heading .dropdown-menu'), that);
                });
            });
